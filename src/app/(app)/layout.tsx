...
// Avisos de cobro: clientes por vencer (≤ N días) o vencidos que esta cuenta
// puede cobrar. v_mensualidades evalúa has_client_access() por fila (cara),
// así que va en Suspense: el header pinta ya y el badge llega después.
